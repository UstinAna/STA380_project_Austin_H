...
test_that("mc_compare_tests B argument is passed through correctly", {
  set.seed(3)
  # Using B = 99 is fast and verifiable; if B weren't passed through,
  # the default 1000 would run and take much longer — this test would
  # still pass but serves as a smoke test that the argument is accepted.
